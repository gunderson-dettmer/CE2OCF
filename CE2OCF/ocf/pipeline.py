...
def package_translated_ce_as_valid_ocf_files_contents(
    ocf_obj: CE2OCFPipelineReturnType,
) -> OcfFileContentsDict:
    ...
    manifest_file_json_contents = {
        ...
        "comments": [f"Auto-generated by Gunderson Dettmer Contract Express Parser v{CAP_EXPRESS_ENGINE_VERSION}"],
...
def package_ocf_files_contents_into_zip_archive(
    ...
    for file_type, contents in ocf_file_contents.items():
        assert isinstance(contents, dict), f"Expected OcfFileParts, got {type(contents)}"
